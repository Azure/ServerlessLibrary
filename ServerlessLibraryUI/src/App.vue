<template>
  <div class="scootover">
    <app-sidebar @updateFilters="updatedFilters = $event" :samples="samples" :filters="filters" />

    <main id="mainContent" class="content">
      <div data-grid="col-12" class="m-area-heading header"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 -10 64 54" enable-background="new 0 -10 64 54"
          xml:space="preserve" class="functionslogo">
          <g>
		...
		L5.3,30.1c-0.6,0.6-0.6,1.7,0,2.3l14.5,14.7c0.6,0.6,0.6,1.7,0,2.3l0,0c-0.6,0.6-1.7,0.5-2.2,0L3.6,36c0,0,0,0-0.1-0.1L0.4,32.4z"></path>
		...
		20.4,61.5 48,22.4 	"></polygon>
          </g>
        </svg><svg id="FxSymbol0-03c" xmlns="http://www.w3.org/2000/svg" viewBox="0 -12 50 51.8" class="logicappslogo">
          <g>
            <path d="M26 21.3v-5h-2.5v5c0 .9-.8 1.7-2.1 2.1l-3.4.7c-2.3.7-3.9 2.5-3.9 4.5v5.7h2.5v-5.7c0-.9.8-1.7 2.1-2.1l3.4-.8c2.3-.6 3.9-2.4 3.9-4.4z"
              class="msportalfx-svg-c15"></path>
            <path d="M19.6 36.9v-4.6c0-1.1-.9-2-2-2H13c-1.1 0-2 .9-2 2v4.6c0 1.1.9 2 2 2h4.6c1.1 0 2-.9 2-2z" class="msportalfx-svg-c14"></path>
            <path d="M23.2 21.3v-5h2.5v5c0 .9.8 1.7 2.1 2.1l4.2.9c2.3.7 3.9 2.5 3.9 4.5v5.7h-2.5v-5.7c0-.9-.8-1.7-2.1-2.1l-4.2-.9c-2.3-.7-3.9-2.5-3.9-4.5z"
              class="msportalfx-svg-c15"></path>
            <path d="M30.4 37.1v-4.6c0-1.1.9-2 2-2H37c1.1 0 2 .9 2 2v4.6c0 1.1-.9 2-2 2h-4.6c-1.1 0-2-.9-2-2z" class="msportalfx-svg-c14"></path>
            <path d="M23.2 16.3H26v4.8h-2.8z" class="msportalfx-svg-c15"></path>
            <path d="M26.5 11.7v3.7h-3.7v-3.7h3.7m.8-2.8H22c-1.1 0-2 .9-2 2v5.3c0 1.1.9 2 2 2h5.3c1.1 0 2-.9 2-2v-5.3c0-1.1-.9-2-2-2z"
              class="msportalfx-svg-c19"></path>
        ...
        <h2 class="c-heading">Azure Serverless Community Library<sup><sup class="previewtag"> (PREVIEW)</sup></sup></h2>
