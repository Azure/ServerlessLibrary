  ...
  render() {
    ...
    return (
      <div className="metrics" >
        <div><span>By: {username} | {this.props.downloads}  downloads {lastupdated} | </span></div>
        <IconButton style={styles.button} iconStyle={styles.icon} tooltipStyles={styles.tooltip} iconProps={{ iconName: this.state.iconName }} title={this.state.title} ariaLabel={this.state.title} onClick={() => this.handleLikeClick()} />
