...
class ItemTags extends Component {
  ...
  render() {
    ...
    if (this.props.type === 'functionapp') {
      svgIcon = <svg width={width} height={width} className="functionslogo"
        xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 54" enableBackground="new 0 -10 64 54" xmlSpace="preserve">
        <g>
          ...
          <polygon opacity="0.3" fill="#FF8C00" enableBackground="new    " points="34.6,22.4 47.6,2.5 37.4,2.5 26.6,27.1 39.4,27.2 20.4,61.5 48,22.4 	"></polygon>
        </g>
      </svg>
    }
    else if (this.props.type === "logicapp") {
      svgIcon = <svg v-if="type === 'logicapp'" width={width} height={width} className="logicappslogo"
